  ...
  return (
    <footer className="relative bg-black border-t border-white/5 overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="py-10 border-b border-white/5">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="bg-white/[0.03] backdrop-blur-sm rounded-sm p-6 border border-white/10">
              <h4 className="text-lg font-semibold text-white mb-2 tracking-tight">Stay Informed</h4>
              <p className="text-sm text-neutral-500 mb-5 font-light">Industry insights delivered to your inbox.</p>
              ...
              {!isSubscribed ? (
                <form onSubmit={handleNewsletterSubmit} className="space-y-3">
                  <input
                    ...
                    className="w-full px-4 py-2.5 bg-black/50 border border-white/20 rounded-sm text-sm text-white placeholder-neutral-600 focus:outline-none focus:border-white/40 transition-colors duration-300"
                    required
                  />
                  <button
                    type="submit"
                    className="w-full flex items-center justify-center px-6 py-2.5 bg-white text-black rounded-sm text-sm font-medium hover:bg-neutral-200 transition-all duration-300 tracking-wide"
                  >
                    SUBSCRIBE
                ...
                <div className="text-center py-4">
                  ...
                  <p className="text-white text-sm font-medium">Subscribed successfully</p>
                </div>
              )}
            </div>
          </div>
        ...
        <div className="py-8 border-b border-white/5">
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="space-y-6">
              <div>
                <h3 className="text-2xl font-bold bg-gradient-to-r from-amber-200 to-neutral-100 bg-clip-text text-transparent tracking-tight">
                  MODELLAIRE
                </h3>
              </div>
              ...
              <div className="flex space-x-2">
                <a href="#" className="w-8 h-8 bg-white/5 rounded-sm flex items-center justify-center hover:bg-white/10 transition-all duration-300 group">
                  <Instagram className="w-4 h-4 text-neutral-400 group-hover:text-white" />
                </a>
                <a href="#" className="w-8 h-8 bg-white/5 rounded-sm flex items-center justify-center hover:bg-white/10 transition-all duration-300 group">
            ...
            <div>
              <h4 className="text-base font-semibold text-white mb-4 tracking-tight">Services</h4>
              <div className="grid grid-cols-2 gap-6">
                {serviceCategories.map((category, index) => (
                  <div key={index}>
                    <h5 className="text-white font-medium mb-2 text-xs uppercase tracking-wider">{category.title}</h5>
                    <ul className="space-y-1.5">
                      {category.services.map((service, serviceIndex) => (
                        <li key={serviceIndex}>
                          <a href="#" className="text-neutral-500 hover:text-white transition-colors duration-300 text-xs font-light">
                            {service}
                          </a>
                        </li>
                      ))}
        ...
        <div className="py-8 border-b border-white/5">
          <div>
            <h4 className="text-base font-semibold text-white mb-4 tracking-tight">Contact</h4>
            <div className="grid md:grid-cols-3 gap-4">
              <a href="mailto:hello@modellairemgmt.com" className="flex items-center text-neutral-400 hover:text-white transition-colors duration-300 group">
                <div className="w-8 h-8 bg-white/5 rounded-sm flex items-center justify-center mr-3 group-hover:bg-white/10">
                  <Mail className="w-4 h-4 text-neutral-400 group-hover:text-white" />
                </div>
                <div>
                  <div className="text-xs font-light">Email</div>
                  <div className="text-xs font-medium">hello@modellaire.com</div>
                </div>
              </a>
              ...
              <a href="tel:+15551234567" className="flex items-center text-neutral-400 hover:text-white transition-colors duration-300 group">
                ...
                <div>
                  ...
                  <div className="text-xs font-medium">+1 (555) 123-4567</div>
                </div>
              </a>

              <div className="flex items-center text-neutral-400">
                <div className="w-8 h-8 bg-white/5 rounded-sm flex items-center justify-center mr-3">
