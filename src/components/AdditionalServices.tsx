    ...
    <section className="py-12 relative">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          <h2 className="text-xs font-medium text-neutral-500 uppercase tracking-widest mb-3">Advanced Solutions</h2>
        ...
        <div className="text-center mt-10">
          <div className="bg-white/[0.03] backdrop-blur-sm rounded-sm p-6 border border-white/10 max-w-2xl mx-auto">
            <h4 className="text-xl font-bold text-white mb-2 tracking-tight">Ready to Begin?</h4>
            ...
            <button className="px-8 py-2.5 bg-white text-black rounded-sm text-sm font-medium hover:bg-neutral-200 transition-all duration-300 tracking-wide">
